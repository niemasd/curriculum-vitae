...
\hspace*{9mm} Rosing T, Knight R (2022). ``Swapping metagenomics preprocessing pipeline\\*\vspace{2mm}
\hspace*{8mm} components offers speed and sensitivity increases.'' \textit{mSystems}. In Press.\\
...
\begin{longtable}{@{}p{0.7in}p{4in}}\rule{-1mm}{4.5mm}
\hspace*{-4mm} Feb 2022 & \textit{First-Year Experience: Coding in Biology -- Professor Panel}\\*
