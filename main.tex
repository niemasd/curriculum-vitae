...
\hspace*{9mm} Goyal R, Skaathun B (2023). ``Leveraging social networks for identification of\\*\vspace{2mm}
\hspace*{8mm} people living with HIV who are virally unsuppressed.'' \textit{AIDS}. In Press.\\
...
\hspace*{9mm} Analysis of Human Genomics, Microbiome Metagenomics, and Viral Sequences.''\\*\vspace{2mm}
\hspace*{7mm} \textit{IEEE Biomedical Circuits and Systems Conference (BioCAS) 2022}. In Press.\\
...
\hspace*{4mm} Ji D, Aboukhalil R, \textbf{Moshiri N} (2023). ``ViralWasm: a client-side user-friendly\\*\vspace{2mm}
\hspace*{8mm} web application suite for viral genomics.'' \textit{Zenodo}. \href{https://doi.org/10.5281/zenodo.7754298}{doi:10.5281/zenodo.7754298}\\
...
\href{https://www.coursera.org/learn/hacking-covid-19--course-3-unraveling-origins-of-covid-19}{\textit{Hacking COVID-19 Course 4: Metabolic Pathway Analysis Yields SARS-CoV-2 Drug Targets}} (UC San Diego \& Coursera, 2023 to Present)\vspace{2mm}\\
...
\begin{longtable}{@{}p{0.7in}p{4in}}\rule{-1mm}{4.5mm}
\hspace*{-4mm} 2023--Present & \href{https://prepare.ucsd.edu/cores/}{\textit{Research Committee Member}}\\*
...
\begin{longtable}{@{}p{0.7in}p{4in}}\rule{-1mm}{4.5mm}
\hspace*{-4mm} 2023--\the\year{} & \textit{\href{https://prism.ucsd.edu/}{PRISM Center}, \href{https://www.src.org/}{Semiconductor Research Corporation (SRC)}}\\*
